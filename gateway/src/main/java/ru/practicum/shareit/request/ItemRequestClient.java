...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> getItemRequestsWithItems(Long userId) {
        return get("", userId);
    }
    ...
    public ResponseEntity<Object> createItemRequest(Long userId, ItemRequestCreateRequestDto requestDto) {
