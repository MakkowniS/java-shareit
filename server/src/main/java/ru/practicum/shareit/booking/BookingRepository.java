...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    @Query("""
            ...
            """)
    List<Booking> findCurrentUserBooking(Long bookerId, String state, Pageable pageable);
    ...
    @Query("""
            ...
            """)
    List<Booking> findOwnerBooking(Long ownerId, String state, Pageable pageable);
