...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    public List<BookingDtoResponse> getBookingsByState(Long userId, String state, Integer from, Integer size) {
        ...
        List<Booking> bookingsList = bookingRepository.findCurrentUserBooking(userId, state, pageable);

        return BookingMapper.mapToBookingDtoResponse(bookingsList);
    }

    @Override
    public List<BookingDtoResponse> getBookingByStateForOwner(Long ownerId, String state, Integer from, Integer size) {
        ...
        List<Booking> bookingsList = bookingRepository.findOwnerBooking(ownerId, state, pageable);
        return BookingMapper.mapToBookingDtoResponse(bookingsList);
    }
